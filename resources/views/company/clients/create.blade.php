...
<div class="animate-fadeIn space-y-8 max-w-6xl mx-auto px-6 relative">
    ...
    <form method="POST" action="{{ route('company.clients.store') }}" class="bg-gradient-to-b from-[var(--primary)] to-[var(--secondary)] p-8 rounded-xl shadow-2xl space-y-8 mt-8 border border-gray-200 max-w-4xl mx-auto relative">
        @csrf
