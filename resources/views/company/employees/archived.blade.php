...
<div class="animate-fadeIn space-y-6">
    <div class="flex items-center justify-between px-2">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">Empleados archivados</h1>
            <p class="text-sm text-gray-500">Listado de empleados no activos</p>
        </div>
        <a href="{{ route('company.employees.index') }}" class="px-4 py-2 rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50">
            Volver
        </a>
    </div>
        ...
        <table class="min-w-full text-sm">
            ...
            <tbody class="text-gray-700 divide-y divide-gray-100">
                @forelse($employees as $employee)
                    <tr>
                        <td class="px-4 py-3 font-semibold">{{ $employee->fullName }}</td>
                        ...
                        <td class="px-4 py-3">
                            <button type="button" class="text-[var(--primary)] hover:underline" data-action-modal data-url="{{ route('company.employees.unarchive', $employee) }}" data-method="PUT" data-title="Desarchivar empleado" data-message="Para desarchivar deja un comentario.">Desarchivar</button>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="px-4 py-8 text-center text-gray-500">No hay empleados archivados.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
