...
<head>
    ...
    <title>Recuperar Contraseña | Centinela360</title>
...
<body>
    ...
    <div class="recover-container">
        <div class="recover-box">
            ...
            <p>¿Olvidaste tu contraseña? No te preocupes. Ingresa tu correo y te enviaremos un enlace para restablecerla.</p>

            <!-- Mensaje de estado -->
            <x-auth-session-status class="mb-4 text-center text-cyan-300" :status="session('status')" />
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <button type="submit" class="btn-recover">Enviar enlace</button>
