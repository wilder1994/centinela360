<div class="flex flex-col gap-4 h-full w-full px-4 sm:px-8 md:px-10 lg:px-14 py-4 sm:py-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        ...
        <div class="flex flex-col sm:flex-row gap-2 sm:items-center">
            ...
            {{-- Buscador: usa la propiedad $search del componente Livewire --}}
            <div class="relative">
                <input
                    type="text"
                    wire:model.debounce.500ms="search"
                    placeholder="Buscar por nombre o correo..."
                    class="w-full sm:w-64 lg:w-80 px-3 py-2 rounded-full border border-slate-200 text-xs sm:text-sm
    ...
    <div class="bg-white shadow-sm rounded-2xl border border-slate-100 p-3 sm:p-4 overflow-x-auto">
        ...
        {{-- Paginación si $users es paginado --}}
