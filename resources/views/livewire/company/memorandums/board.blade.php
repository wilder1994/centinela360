...
<div class="flex flex-col gap-4 h-full w-full">
    ...
    {{-- 📋 Listado general de memorandos --}}
    <div class="flex-1 bg-white shadow-sm rounded-2xl border border-slate-100 p-3 sm:p-4 overflow-auto">
        <h3 class="font-semibold mb-3 text-gray-800 text-sm sm:text-base">{{ $tituloTabla ?? 'Listado de memorandos' }}</h3>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6
                ...
                @if($cambioEstado)
                    <p class="mb-3 text-gray-700 text-sm">
                        Este memorando pasará al estado:
                ...
                @else
                    <p class="mb-3 text-gray-700 text-sm">
                        Se registrará un comentario sin modificar el estado actual del memorando.
                    </p>
                @endif
        ...
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-2xl shadow-lg p-6
                ...
                <h2 class="text-lg font-bold mb-4 text-gray-800">
                    Detalles del memorando #{{ $ticketDetalle->id }}
                </h2>
